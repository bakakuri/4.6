...
function Inner() {
  ...
  // Note: useEffect can't be called after early returns in normal flow,
  // but we reach here only after profile is loaded. We use a flag.
  // These subscriptions are established via HomeScreen's supabase import.
  // The notification toast is rendered in the return below.
  ...
  return (
    <div style={{ background: C.bg, minHeight:'100vh', maxWidth:480, margin:'0 auto', position:'relative' }}>
      ...
      <BottomNav page={page} onNav={setPage} isAdmin={user.isAdmin} friendReqCount={friendReqCount} />
