...
function Inner() {
  ...
  return (
    <div style={{ background:C.bg, minHeight:'100vh', maxWidth:480, margin:'0 auto', position:'relative', transition:'background 0.3s' }}>
      <Header lang={lang} onSidebar={() => setSidebarOpen(o => !o)} />
      <Sidebar open={sidebarOpen} onClose={() => setSidebarOpen(false)} onNav={setPage} activeCat={dictCat} onCat={setDictCat} />
      <div style={{ paddingTop:56, paddingBottom:70, minHeight:'100vh', background:C.bg, color:C.t, fontFamily:"'Inter',system-ui,sans-serif", overflowY:'auto', transition:'background 0.3s, color 0.3s' }}>
        ...
        {page==='settings'    && <SettingsScreen   user={user} lang={lang} onLangChange={() => setShowLangSel(true)} onLogout={handleLogout} />}
